...
public class Player : MonoBehaviour
{
    ...
    public float normalGravity = 0;//获得玩家重力
...
class PhysicsUpdate
{
    ...
    {
        player.onGround = Physics2D.Raycast(player.transform.position, Vector2.down + Vector2.left, 0.85f, player.objectLayer)
            || Physics2D.Raycast(player.transform.position, Vector2.down + Vector2.right, 0.85f, player.objectLayer);
