...
public abstract class FSMState
{
    ...
    /// </summary>
    public virtual void DoBeforeEntering(Player player) { }
    ...
    /// </summary>
    public virtual void DoBeforeLeaving(Player player) { }
...
public class FSMSystem
{
    ...
    /// </summary>
    public void PerformTransition(Transition trans, Player player)
    {
        ...
        foreach (FSMState state in states)
        {
            if (state.ID == currentStateID)
            {
                ...
                currentState.DoBeforeLeaving(player);
